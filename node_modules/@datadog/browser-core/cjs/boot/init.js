...
const catchUserErrors_1 = require("../tools/catchUserErrors");
...
function defineGlobal(global, name, api) {
    ...
    if (existingGlobalVariable && existingGlobalVariable.q) {
        existingGlobalVariable.q.forEach((fn) => (0, catchUserErrors_1.catchUserErrors)(fn, 'onReady callback threw an error:')());
    }
}
