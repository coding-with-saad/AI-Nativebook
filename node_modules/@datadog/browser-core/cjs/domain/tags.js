...
function buildTags(configuration) {
    ...
    const tags = [buildTag('sdk_version', sdkVersion !== null && sdkVersion !== void 0 ? sdkVersion : "6.26.0")];
    if (env) {
...
function buildTag(key, rawValue) {
    ...
    if (tag.length > exports.TAG_SIZE_LIMIT || hasForbiddenCharacters(tag)) {
        display_1.display.warn(`Tag ${tag} doesn't meet tag requirements and will be sanitized. ${display_1.MORE_DETAILS} ${display_1.DOCS_ORIGIN}/getting_started/tagging/#defining-tags`);
    }
