import type { Duration, ErrorSource, ErrorHandling, ResourceType, ServerDuration, TimeStamp, RawErrorCause, DefaultPrivacyLevel, Csp, Context } from '@datadog/browser-core';
import type { GraphQlMetadata } from './domain/resource/graphql';
import type { PageState } from './domain/contexts/pageStateHistory';
import type { RumActionEvent, RumErrorEvent, RumLongTaskEvent, RumResourceEvent, RumViewEvent, RumVitalEvent } from './rumEvent.types';
export declare const RumEventType: {
    readonly ACTION: "action";
    readonly ERROR: "error";
    readonly LONG_TASK: "long_task";
    readonly VIEW: "view";
    readonly RESOURCE: "resource";
    readonly VITAL: "vital";
};
export type RumEventType = (typeof RumEventType)[keyof typeof RumEventType];
export type AssembledRumEvent = (RumViewEvent | RumActionEvent | RumResourceEvent | RumErrorEvent | RumVitalEvent | RumLongTaskEvent) & Context;
export declare const RumLongTaskEntryType: {
    readonly LONG_TASK: "long-task";
    readonly LONG_ANIMATION_FRAME: "long-animation-frame";
};
...
export declare const ViewLoadingType: {
    readonly INITIAL_LOAD: "initial_load";
    readonly ROUTE_CHANGE: "route_change";
    readonly BF_CACHE: "bf_cache";
};
...
export declare const ActionType: {
    ...
    readonly APPLICATION_START: "application_start";
    readonly BACK: "back";
};
export type ActionType = (typeof ActionType)[keyof typeof ActionType];
export declare const FrustrationType: {
...
export declare const VitalType: {
    readonly DURATION: "duration";
    readonly OPERATION_STEP: "operation_step";
};
