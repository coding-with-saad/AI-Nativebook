...
function createPreStartStrategy({ ignoreInitIfSyntheticsWillInjectRum = true, startDeflateWorker }, trackingConsentState, customVitalsState, doStartRum) {
    ...
    function doInit(initConfiguration, errorStack) {
        ...
        const configuration = (0, configuration_1.validateAndBuildRumConfiguration)(initConfiguration, errorStack);
        if (!configuration) {
            return;
        }
    ...
    const addOperationStepVital = (name, stepType, options, failureReason) => {
        bufferApiCalls.add((startRumResult) => startRumResult.addOperationStepVital((0, browser_core_1.sanitize)(name), stepType, (0, browser_core_1.sanitize)(options), (0, browser_core_1.sanitize)(failureReason)));
    };
    const strategy = {
        init(initConfiguration, publicApi, errorStack) {
            ...
            if (initConfiguration.remoteConfigurationId) {
                (0, configuration_1.fetchAndApplyRemoteConfiguration)(initConfiguration, { user: userContext, context: globalContext })
        ...
        stopAction(name, options) {
            const stopClocks = (0, browser_core_1.clocksNow)();
