...
function makeRumPublicApi(startRumImpl, recorderApi, profilerApi, options = {}) {
    ...
    const rumPublicApi = (0, browser_core_1.makePublicApi)({
        init: (initConfiguration) => {
            ...
            (0, browser_core_1.callMonitored)(() => strategy.init(initConfiguration, rumPublicApi, errorStack));
        },
        ...
        startAction: (0, browser_core_1.monitor)((name, options) => {
            // Check feature flag only after init; pre-init calls should be buffered
            if (strategy.initConfiguration && !(0, browser_core_1.isExperimentalFeatureEnabled)(browser_core_1.ExperimentalFeature.START_STOP_ACTION)) {
                return;
            }
            // addTelemetryUsage({ feature: 'start-action' })
            strategy.startAction((0, browser_core_1.sanitize)(name), {
                type: (0, browser_core_1.sanitize)(options && options.type),
                context: (0, browser_core_1.sanitize)(options && options.context),
                actionKey: options && options.actionKey,
            });
        }),
        stopAction: (0, browser_core_1.monitor)((name, options) => {
            if (strategy.initConfiguration && !(0, browser_core_1.isExperimentalFeatureEnabled)(browser_core_1.ExperimentalFeature.START_STOP_ACTION)) {
                return;
            }
            // addTelemetryUsage({ feature: 'stop-action' })
            strategy.stopAction((0, browser_core_1.sanitize)(name), {
                type: (0, browser_core_1.sanitize)(options && options.type),
                context: (0, browser_core_1.sanitize)(options && options.context),
                actionKey: options && options.actionKey,
            });
        ...
        succeedFeatureOperation: (0, browser_core_1.monitor)((name, options) => {
            (0, browser_core_1.addTelemetryUsage)({ feature: 'add-operation-step-vital', action_type: 'succeed' });
            strategy.addOperationStepVital(name, 'end', options);
        }),
        failFeatureOperation: (0, browser_core_1.monitor)((name, failureReason, options) => {
            (0, browser_core_1.addTelemetryUsage)({ feature: 'add-operation-step-vital', action_type: 'fail' });
