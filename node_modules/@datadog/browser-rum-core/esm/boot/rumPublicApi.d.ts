import type { Context, DeflateWorker, DeflateEncoderStreamId, DeflateEncoder, PublicApi, ContextManager, TrackingConsent, User, Account, RumInternalContext, Telemetry, Encoder } from '@datadog/browser-core';
...
import type { AddDurationVitalOptions, DurationVitalReference, DurationVitalOptions, FeatureOperationOptions, FailureReason } from '../domain/vital/vitalCollection';
...
export interface RecorderApi {
    ...
    stop: () => void;
    onRumStart: (lifeCycle: LifeCycle, configuration: RumConfiguration, sessionManager: RumSessionManager, viewHistory: ViewHistory, deflateWorker: DeflateWorker | undefined, telemetry: Telemetry) => void;
    isRecording: () => boolean;
...
export interface ProfilerApi {
    stop: () => void;
    onRumStart: (lifeCycle: LifeCycle, hooks: Hooks, configuration: RumConfiguration, sessionManager: RumSessionManager, viewHistory: ViewHistory, longTaskContexts: LongTaskContexts, createEncoder: (streamId: DeflateEncoderStreamId) => Encoder) => void;
}
